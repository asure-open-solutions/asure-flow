    ...
    <>
      <div ref={ref} className="relative">
        <button
          ...
          disabled={generating}
          className={cn(
            "rounded-lg p-1.5 text-white/40 hover:text-white/80 hover:bg-white/5 transition-colors",
        ...
        {open && (
          <div className="absolute right-0 top-full z-30 mt-1.5 w-52 rounded-xl border border-white/10 bg-zinc-900 py-1 shadow-2xl">
            {/* Connection status */}
            ...
            {currentSession && (
              <>
                <button
                  ...
                  className="flex w-full items-center gap-2.5 px-3 py-2 text-sm text-white/70 hover:bg-white/5 transition-colors"
                >
            ...
            {window.electronAPI && (
              ...
              >
                ...
                Toggle Overlay
                <span className="ml-auto text-xs text-white/30">Ctrl+Shift+O</span>
              </button>
            )}
          </div>
        )}
